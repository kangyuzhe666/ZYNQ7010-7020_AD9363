...
set_property  -dict {PACKAGE_PIN  L16  IOSTANDARD LVCMOS18} [get_ports pl_spi_clk_o]
set_property  -dict {PACKAGE_PIN  L17  IOSTANDARD LVCMOS18} [get_ports pl_spi_miso]
set_property  -dict {PACKAGE_PIN  K17  IOSTANDARD LVCMOS18} [get_ports pl_spi_mosi]
...
set_property  -dict {PACKAGE_PIN C8B  PULLTYPE PULLUP} [get_ports fixed_io_mio[15]]
